...
//            [self requestFriendsList];
            ...
            [RCIM connectWithToken:loginToken completion:^(NSString *userId) {
                ...
                NSString* userEmail = [(UITextField *)[self.view viewWithTag:Tag_EmailTextField] text];
                [[NSUserDefaults standardUserDefaults] setObject:loginToken forKey:@"DeviceToken"];
                [[NSUserDefaults standardUserDefaults] setObject:userEmail forKey:@"cookie"];
                [[NSUserDefaults standardUserDefaults] setObject:userInfo.userId forKey:@"userInfo_id"];
